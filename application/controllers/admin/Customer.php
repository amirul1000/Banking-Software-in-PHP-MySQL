...
$updated_at = "";
		...
		$params = array(
					 'ACC_No' => html_escape($this->input->post('ACC_No')),
...
'updated_at' =>$updated_at,
						...
						$config['upload_path']          = "./public/uploads/images/customer";
							  ...
							  if(strlen($_FILES['file_picture']['name'])>0 && $_FILES['file_picture']['size']>0)
								{
									...
									{
										$file_picture = "uploads/images/customer/".$_FILES['file_picture']['name'];
...
$this->db->or_like('ACC_No', $key, 'both');
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","ACC No","First Name","Last Name","Email","Phone","File Picture","Dob","Address","Created At","Updated At"); 
		   fputcsv($file, $header);
