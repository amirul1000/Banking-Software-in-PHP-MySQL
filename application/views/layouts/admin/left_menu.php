...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="currency"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/currency/index'); ?>"><i class="icon_table"></i>Currency</a></li>
...
<li <?php if($this->router->fetch_class()=="transactions"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/transactions/index'); ?>"><i class="icon_table"></i>Transactions</a></li>
